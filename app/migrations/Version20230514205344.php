...
final class Version20230514205344 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_6A41727A87F4FB17 ON appointment');
        $this->addSql('ALTER TABLE appointment CHANGE doctor_id medic_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE appointment ADD CONSTRAINT FK_6A41727A409615FE FOREIGN KEY (medic_id) REFERENCES `user` (id) ON DELETE CASCADE');
        $this->addSql('CREATE INDEX IDX_6A41727A409615FE ON appointment (medic_id)');
        $this->addSql('ALTER TABLE schedule DROP FOREIGN KEY FK_313BDC8E87F4FB17');
        $this->addSql('DROP INDEX IDX_313BDC8E87F4FB17 ON schedule');
        $this->addSql('ALTER TABLE schedule CHANGE doctor_id medic_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE schedule ADD CONSTRAINT FK_313BDC8E409615FE FOREIGN KEY (medic_id) REFERENCES `user` (id) ON DELETE CASCADE');
        $this->addSql('CREATE INDEX IDX_313BDC8E409615FE ON schedule (medic_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE schedule DROP FOREIGN KEY FK_313BDC8E409615FE');
        $this->addSql('DROP INDEX IDX_313BDC8E409615FE ON schedule');
        $this->addSql('ALTER TABLE schedule CHANGE medic_id doctor_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE schedule ADD CONSTRAINT FK_313BDC8E87F4FB17 FOREIGN KEY (doctor_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        $this->addSql('CREATE INDEX IDX_313BDC8E87F4FB17 ON schedule (doctor_id)');
        $this->addSql('ALTER TABLE appointment DROP FOREIGN KEY FK_6A41727A409615FE');
        $this->addSql('DROP INDEX IDX_6A41727A409615FE ON appointment');
        $this->addSql('ALTER TABLE appointment CHANGE medic_id doctor_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE appointment ADD CONSTRAINT FK_6A41727A87F4FB17 FOREIGN KEY (doctor_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        $this->addSql('CREATE INDEX IDX_6A41727A87F4FB17 ON appointment (doctor_id)');
